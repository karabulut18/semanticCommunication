...
class pkt_rcv(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_char, 1, 'tcp://127.0.0.1:49207', 100, False, (-1), '', True, True)
        ...
        self.connect((self.digital_crc32_bb_0_0, 0), (self.zeromq_pub_sink_0, 0))
