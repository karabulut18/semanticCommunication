...
class pkt_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_char, 1, 'tcp://127.0.0.1:49209', 100, False, (-1), '', False)
        ...
        self.epy_block_0 = epy_block_0.blk(Pkt_len=60, debug_active=False)
